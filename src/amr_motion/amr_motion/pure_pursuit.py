...
class PurePursuit(Node):
    def __init__(self):
        ...
        self.nav_cmd_vel = self.create_publisher(Twist, "/nav_cmd_vel", 10)
    ...
    def control_loop(self):
        ...
        nav_cmd_vel = Twist()
        nav_cmd_vel.linear.x = self.max_linear_velocity
        nav_cmd_vel.angular.z = curvature * self.max_angular_velocity
        self.nav_cmd_vel.publish(nav_cmd_vel)
